    ...
    <div class="content" v-for="item in data" :key="item.id">
      <div class="item-box">
        <el-row type="flex" class="item-row" justify="space-between">
          <el-col class="row-name" :span="8">跟进时间</el-col>
          <el-col class="tip" :span="16">{{
            formatter('created_time', item.created_time)
          }}</el-col>
        </el-row>
        <el-row type="flex" class="item-row" justify="space-between">
          <el-col class="row-name" :span="8">跟进状态</el-col>
          <el-col class="tip" :span="16">{{ item.follow_up_type }}</el-col>
        </el-row>
        <el-row type="flex" class="item-row" justify="space-between">
          <el-col class="row-name" :span="8">跟进执行人</el-col>
          <el-col class="tip" :span="16">{{ item.executor_name }}</el-col>
        </el-row>
        <el-row type="flex" class="item-row" justify="space-between">
